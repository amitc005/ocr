...
class sendMail {
    ...
    function genrateHeader() {
        ...
        (is_array($this->bcc) && count($this->bcc) > 0) {
    ...
    public function sendEmail() {
        ...
        if (mail($this->genrateHeaderStr($this->receive), $this->subject, $this->message, $mailHeader)) {
            $msg = "<span style='color:#00FF00;font-size:14px'><b>Mail Sent Successfully.</b>";
        } else {
            $msg = "<span style='color:#FF0000;font-size:14px'><b>Sorry! Unable to send mail.</b>";
        }
        return $msg;
    }
